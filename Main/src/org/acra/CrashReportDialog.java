...
import com.bitants.quickappinstall.MyApplication;
import com.bitants.quickappinstall.R;
import org.acra.ErrorReporter.ReportsSenderWorker;

/**
 * This is the dialog Activities used by ACRA to get authorization from the user
...
public class CrashReportDialog extends Activity {
     ...
     * (non-Javadoc)
     * 
     * @see android.app.Activities#onCreate(android.os.Bundle)
     */
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Bundle crashResources = ((MyApplication)getApplication())
                .getCrashReporter().getCrashResources();
        ...
        text.setText(getText(crashResources.getInt(CrashReportingLibrary.RES_DIALOG_TEXT)));
        ...
        int commentPromptId = crashResources
                .getInt(CrashReportingLibrary.RES_DIALOG_COMMENT_PROMPT);
        ...
        yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int toastId = crashResources
                        .getInt(CrashReportingLibrary.RES_DIALOG_OK_TOAST);
                if (toastId != 0) {
        ...
        int resTitle = crashResources
                .getInt(CrashReportingLibrary.RES_DIALOG_TITLE);
        if (resTitle != 0) {
            setTitle(resTitle);
        }

        int resLeftIcon = crashResources
                .getInt(CrashReportingLibrary.RES_DIALOG_ICON);
        if (resLeftIcon != 0) {
    ...
    protected void cancelNotification() {
        ...
        notificationManager.cancel(CrashReportingLibrary.NOTIF_CRASH_ID);
    }
