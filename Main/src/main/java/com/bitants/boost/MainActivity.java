...
//				finish();
	...
	private void createShortcut()
	{
		 ...
		 ComponentName componentName = new ComponentName(getPackageName(), "com.mojing.demo360.CleanActivity");
		 shortcutIntent.setComponent(componentName);
		 shortcut.putExtra(Intent.EXTRA_SHORTCUT_INTENT, shortcutIntent);
		 ShortcutIconResource iconRes=null;
		 iconRes = ShortcutIconResource.fromContext(this, R.drawable.shortcut_process_clear_shortcut_icon);
