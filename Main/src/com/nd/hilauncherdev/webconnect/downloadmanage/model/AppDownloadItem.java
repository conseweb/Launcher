...
/** 
 *@deprecated 
 * 此下载信息辅助类已废弃,新版本建议不要再实用,需要时可
 * 用 com.nd.hilauncherdev.webconnect.downloadmanage.model.BaseDownloadInfo代替
 * 
 * @author wanggm
 */
public class AppDownloadItem implements ICommonDataItem,Serializable{
	...
	public boolean equals(Object o) {
		...
		if(!(o instanceof AppDownloadItem))
			return false;
		
		try {
			
			AppDownloadItem target=(AppDownloadItem)o;
