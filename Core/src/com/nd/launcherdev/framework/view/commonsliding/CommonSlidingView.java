package com.nd.launcherdev.framework.view.commonsliding;
...
import com.nd.launcherdev.framework.effect.DrawerEffects;
...
import com.nd.launcherdev.framework.view.draggersliding.DrawerLayout;
...
public abstract class CommonSlidingView extends ViewGroup implements OnClickListener, OnLongClickListener {
	 ...
	 * 4.0桌面的屏幕指示灯
	 */
	protected BaseLineLightbar lineLightbar;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			if (isEffectOpened)
				EffectsType.setCurrentDrawerEffect(BaseSettingsPreference.getInstance().getDrawerScrollEffects());
			break;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			mTouchState = TOUCH_STATE_REST;
			if(EffectsType.getCurrentDrawerEffect()>=EffectsType.GLOBAL&&
			   EffectsType.getCurrentDrawerEffect()<=EffectsType.TORNADO){
				invalidate();
			}
			break;
		case MotionEvent.ACTION_CANCEL:
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if (fastDraw) {
			...
			if (EffectsType.isDrawerLeftScreenFirst()) {
	 ...
	 * @param lineLightbar
	 */
	public void setLineLightbar(BaseLineLightbar lineLightbar) {
...
//		}
	 ...
	 * @return LineLightbar
	 */
	public BaseLineLightbar getLineLightbar() {
		return lineLightbar;
	}
