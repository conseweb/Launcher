package com.nd.launcherdev.launcher.view.icon.ui.strategy;

import android.util.SparseArray;

import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.IconBackgroundDrawStragegy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.IconDrawStrategy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.IconFrontgroundDrawStrategy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.IconHintDrawStrategy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.IconMaskDrawStrategy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.IconNewInstallDrawStrategy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.IconNewMaskDrawStrategy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.LargeIconBackgroundDrawStrategy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.PreDrawStragegy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.TextBackgroundDrawStrategy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.TextDrawStrategy;
import com.nd.launcherdev.launcher.view.icon.ui.strategy.impl.*;
