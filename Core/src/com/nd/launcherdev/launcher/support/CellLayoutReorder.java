...
//    	result = findNearestArea(pixelX, pixelY, spanX, spanY, result);
    ...
    private void getViewsIntersectingRegion(int cellX, int cellY, int spanX, int spanY,
        ...
        for (int i = 0; i < count; i++) {
        	...
        	if(child instanceof AnyCallbacks.OnDragEventCallback){
...
//        if(tempView == null && !mItemPlacementDirty){
        ...
        if(child != null){
        	...
        	if(lastTarget[0] < 0){
        		CellLayout.LayoutParams cl = (CellLayout.LayoutParams) child.getLayoutParams();
...
//                	child.clearAnimation();
    ...
    //判断是否快速滑动导致移动动画中断
    public boolean interruptReorderAnimation(CellLayout.LayoutParams lp){
