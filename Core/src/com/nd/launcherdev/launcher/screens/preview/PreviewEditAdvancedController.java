package com.nd.launcherdev.launcher.screens.preview;
...
import com.nd.launcherdev.framework.view.commonsliding.CommonSlidingView.OnCommonSlidingViewClickListener;
import com.nd.launcherdev.framework.view.commonsliding.CommonSlidingView.OnCommonSlidingViewLongClickListener;
import com.nd.launcherdev.framework.view.commonsliding.CommonSlidingView.OnSwitchDataListener;
...
import com.nd.launcherdev.framework.view.draggersliding.datamodel.DraggerSlidingViewData;
...
//			mScreensEditor.setBackgroundDrawable(bg);
	 ...
	 * @see com.nd.launcherdev.framework.OnKeyDownListenner#onKeyDownProcess(int, android.view.KeyEvent)
	 */
	@Override
	 ...
	 * @see com.nd.launcherdev.framework.view.commonsliding.CommonSlidingView.OnCommonSlidingViewLongClickListener#onItemLongClick(android.view.View, int, int, int, com.nd.launcherdev.framework.view.commonsliding.datamodel.ICommonData)
	 */
	@Override
	 ...
	 * @see com.nd.launcherdev.framework.view.commonsliding.CommonSlidingView.OnCommonSlidingViewClickListener#onItemClick(android.view.View, int, int, int, com.nd.launcherdev.framework.view.commonsliding.datamodel.ICommonData)
	 */
	@Override
