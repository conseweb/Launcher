 ...
 */
public class FolderIconTextView extends EditableIconView implements OnDragEventCallback, ThemeUIRefreshListener {
	...
	public void checkUserFolderContents() {
		...
		if (size == 0) {
			...
			if(isOnDockbar()){//dock栏上文件夹
				...
				if(cellLayout == null)
					return;
				CellLayout.LayoutParams lp = (LayoutParams) getLayoutParams();
