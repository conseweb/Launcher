...
import com.nd.hilauncherdev.launcher.screens.preview.PreviewCellInfo;
import com.nd.hilauncherdev.launcher.support.BaseCellLayoutHelper;
import com.nd.hilauncherdev.launcher.touch.Alarm;
import com.nd.hilauncherdev.launcher.touch.BaseDragController;
import com.nd.hilauncherdev.launcher.touch.DragSource;
import com.nd.hilauncherdev.launcher.touch.WorkspaceDragAndDrop;
import com.nd.hilauncherdev.launcher.touch.outline.DragHelper;
	...
	public void onDragExit(DragSource source, int x, int y, int xOffset, int yOffset, DragView dragView, Object dragInfo){
		...
		if ((dragInfo instanceof ApplicationInfo  || dragView.getDragingView() instanceof OnDragEventCallback)
			...
			if (mLastDragOverView instanceof OnDragEventCallback) {
				CellLayout.LayoutParams lp = (LayoutParams) mLastDragOverView.getLayoutParams();
