...
import com.nd.hilauncherdev.kitset.util.HiAnimationUtils;
...
//			mScreensEditor.setBackgroundDrawable(bg);
	 ...
	 * @see com.nd.hilauncherdev.framework.OnKeyDownListenner#onKeyDownProcess(int, android.view.KeyEvent)
	 */
	@Override
	 ...
	 * @see com.nd.hilauncherdev.framework.view.commonsliding.CommonSlidingView.OnCommonSlidingViewLongClickListener#onItemLongClick(android.view.View, int, int, int, com.nd.hilauncherdev.framework.view.commonsliding.datamodel.ICommonData)
	 */
	@Override
	 ...
	 * @see com.nd.hilauncherdev.framework.view.commonsliding.CommonSlidingView.OnCommonSlidingViewClickListener#onItemClick(android.view.View, int, int, int, com.nd.hilauncherdev.framework.view.commonsliding.datamodel.ICommonData)
	 */
	@Override
