...
//		if (BaseConfig.isDrawWallPaper && type >= EffectsType.SHUTTER && type <= EffectsType.SNAKE) {
	 ...
	 * @param realTimeMove
	 */
	public static int GetMoveDistance(View childView, LayoutParams params, int pathH, int pathV, int realTimeMove) {
		int moveDistance = 0;
	 ...
	 * @param point
	 */
	public static void GetPost(View childView, int countY, LayoutParams params, int moveDistance, int pathH, int pathV, Point point) {
		int totalMoveD = 0;
		point.x = 0;
		point.y = 0;
