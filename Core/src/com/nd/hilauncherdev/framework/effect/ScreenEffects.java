...
import com.nd.hilauncherdev.launcher.support.BitmapWeakReferences;
...
//		float mAngle = (float) ((-Math.sin(Math.abs(shiftingX)/screenWidth*Math.PI)+1)*30 + 8);
	 ...
	 * @param realTimeMove
	 */
	public int GetMoveDistance(View childView, LayoutParams params, int pathH, int pathV, int realTimeMove) {
		int moveDistance = 0;
	 ...
	 * @param point
	 */
	public void GetPost(View childView, int countY, LayoutParams params, int moveDistance, int pathH, int pathV, Point point) {
		int row = 0;
