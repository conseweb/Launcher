...
import com.bitants.common.launcher.view.icon.icontype.impl.AppIconType;
import com.bitants.common.launcher.view.icon.icontype.impl.DockDefaultFourIconType;
import com.bitants.common.launcher.view.icon.icontype.impl.HintIconType;
import com.bitants.common.launcher.view.icon.icontype.impl.SystemShortcutIconType;
...
public class IconTypeFactoryManager {
		...
		public IconType getIconType(Object o){
			if(o != null){
				if(o instanceof ApplicationInfo){
					...
					if(BaseLauncherSettings.BaseLauncherColumns.ITEM_TYPE_APPLICATION == info.itemType){
					...
					//系统快捷 包括dock栏默认的4个图标
					if(BaseLauncherSettings.BaseLauncherColumns.ITEM_TYPE_SHORTCUT == info.itemType){
	...
	public static boolean isDockBarFourIcon(ApplicationInfo mAppInfo){
		...
		if(BaseLauncherSettings.BaseLauncherColumns.ITEM_TYPE_SHORTCUT == mAppInfo.itemType){
