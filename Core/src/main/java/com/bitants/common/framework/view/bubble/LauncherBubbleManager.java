...
import com.bitants.common.push.PushManager;
...
//            PushManager.getInstance().getPushSDKAdapter().statClickPushNotification("" + pushId);
    ...
    private void showBubble(BubbleItem mBubbleItem, View hostView) {
        if(hostView.getParent() != null && hostView.getLayoutParams() instanceof CellLayout.LayoutParams) {
            CellLayout.LayoutParams lp = (CellLayout.LayoutParams)hostView.getLayoutParams();
    ...
    private View getFirstTargetViewOnWorkspace(String intentKey) {
        ...
        try {
            ...
            c = e.query(BaseLauncherSettings.Favorites.getContentUri(), (String[])null, "container=-100 AND intent like\'%" + intentKey + "%\'", (String[])null, (String)null);
