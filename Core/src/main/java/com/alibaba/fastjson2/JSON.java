...
import com.alibaba.fastjson2.parser.deserializer.ParseProcess;
import com.alibaba.fastjson2.serializer.AfterFilter;
import com.alibaba.fastjson2.serializer.BeforeFilter;
import com.alibaba.fastjson2.serializer.JSONSerializer;
import com.alibaba.fastjson2.serializer.NameFilter;
...
import com.alibaba.fastjson2.serializer.SerializeFilter;
...
import com.alibaba.fastjson2.util.ThreadLocalCache;
...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    static {
        int features = 0;
        features |= com.alibaba.fastjson2.serializer.SerializerFeature.QuoteFieldNames.getMask();
        features |= com.alibaba.fastjson2.serializer.SerializerFeature.SkipTransientField.getMask();
        features |= com.alibaba.fastjson2.serializer.SerializerFeature.WriteEnumUsingToString.getMask();
        features |= com.alibaba.fastjson2.serializer.SerializerFeature.SortField.getMask();
        // features |=
    ...
    public static final String toJSONString(Object object, SerializerFeature... features) {
        ...
        try {
            ...
            for (com.alibaba.fastjson2.serializer.SerializerFeature feature : features) {
