...
import static com.alibaba.fastjson2.util.ASMUtils.getDesc;
import static com.alibaba.fastjson2.util.ASMUtils.getType;
...
import com.alibaba.fastjson2.asm.FieldVisitor;
import com.alibaba.fastjson2.asm.Label;
import com.alibaba.fastjson2.asm.MethodVisitor;
import com.alibaba.fastjson2.asm.Opcodes;
import com.alibaba.fastjson2.parser.DefaultJSONParser;
import com.alibaba.fastjson2.parser.DefaultJSONParser.ResolveTask;
import com.alibaba.fastjson2.parser.Feature;
import com.alibaba.fastjson2.parser.JSONLexer;
import com.alibaba.fastjson2.parser.JSONLexerBase;
import com.alibaba.fastjson2.parser.JSONToken;
import com.alibaba.fastjson2.parser.ParseContext;
import com.alibaba.fastjson2.parser.ParserConfig;
import com.alibaba.fastjson2.parser.SymbolTable;
import com.alibaba.fastjson2.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
import com.alibaba.fastjson2.util.ASMClassLoader;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.alibaba.fastjson2.asm.Type.getType(getDesc(fieldClass)));
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.alibaba.fastjson2.asm.Type.getType(getDesc(itemClass)));
    ...
    void _deserialze(ClassWriter cw, Context context) {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.alibaba.fastjson2.asm.Type.getType(getDesc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_list_item_deser__",
                          getDesc(ObjectDeserializer.class));
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.alibaba.fastjson2.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass) {
        ...
        if (fieldInfo.getFieldType() instanceof Class) {
            mw.visitLdcInsn(com.alibaba.fastjson2.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        } else {
            mw.visitVarInsn(ALOAD, 0);
            mw.visitLdcInsn(fieldInfo.getName());
